...
# Fit a deep learning autoencoder

h2o.deeplearning.model3 = h2o.deeplearning(x = col, 
...
h2o.deeplearning.model3
h2o.auc(h2o.deeplearning.model3)

#AUC: 0.7790996

h2o.logloss(h2o.deeplearning.model3)
h2o.confusionMatrix(h2o.deeplearning.model3)
...
h2o.deeplearning.model3.pred = h2o.predict(object = h2o.deeplearning.model3, newdata = test.hex)
h2o.deeplearning.model3.pred
class(h2o.deeplearning.model3.pred)


# Transform H20Frame to DataFrame
h2o.deeplearning.model3.pred.df <-as.data.frame(h2o.predict(object = h2o.deeplearning.model3, newdata = test.hex))
h2o.deeplearning.model3.pred.df
class(h2o.deeplearning.model3.pred.df)
...
submission <- data.frame(ID=test.id, TARGET=h2o.deeplearning.model3.pred.df)
cat("saving the submission file\n")
write.csv(submission, "outputs/predictions/h2o.deeplearning.model3.pred.df.csv", row.names = F)
