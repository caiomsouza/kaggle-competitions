/*************************************************************************************
 MACRO redneuronal(archivo=,listclass=,listconti=,vardep=,porcen=,semilla=,ocultos=,meto=,acti=);
...
vardep=logsalary,porcen=0.80,semilla=442711,ocultos=15,meto=LEVMAR,acti=TANH);
*/
