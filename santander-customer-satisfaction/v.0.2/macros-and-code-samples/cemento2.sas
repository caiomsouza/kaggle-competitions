/* variables (7)(component kg in one M^3 concrete):
Cement
Slag
Fly ash
Water
...
*/
data cement;infile cards dlm=',';
input
No Cement Slag Fly Water SP Coarse Fine SLUMP FLOW Strength ;
cards;
...
%randomselect(data=cement,
listclass=,
vardepen=slump,
modelo=Cement Slag Fly Water SP Coarse Fine  ,
criterio=AIC,
sinicio=12345,
sfinal=12400,
fracciontrain=0.8);
...
%cruzada(archivo=cement,vardepen=slump,
conti= Slag Water ,
categor=,
...
%cruzada(archivo=cement,vardepen=slump,
conti= Cement Slag Fly Water ,/* mejor modelo AIC, BIC Y SBC */
categor=,
ngrupos=4,sinicio=12345,sfinal=12375);
data final1;set final;modelo=1;

%cruzada(archivo=cement,vardepen=slump,
conti= Slag Water / noint, /* prueba sin intercept */
categor=,
ngrupos=4,sinicio=12345,sfinal=12375);
...
%cruzadaneural(archivo=cement,vardepen=slump,
conti= Slag Water ,
categor=,
ngrupos=4,sinicio=12345,sfinal=12375,ocultos=5,early=,algo=levmar);
data final2;set final;modelo=2;

/* este ultimo con bprop, mom=0.9 */
%cruzadaneural(archivo=cement,vardepen=slump,
conti=    Slag Water,
categor=,
ngrupos=4,sinicio=12345,sfinal=12375,ocultos=5,early=,algo=bprop mom=0.9 learn=0.1);
data final3;set final;modelo=3;

title j=c '2=red con levmar,3=red con bprop,4 levmar early15,5 bprop early30 mom=0.9' ; 

%cruzadaneural(archivo=cement,vardepen=slump,
conti= Slag Water ,
categor=,
ngrupos=4,sinicio=12345,sfinal=12375,ocultos=5,early=15,algo=levmar);
...
conti=    Slag Water,
categor=,
ngrupos=4,sinicio=12345,sfinal=12375,ocultos=5,early=30,algo=bprop mom=0.9 learn=0.1);
data final5;set final;modelo=5;


/* LO MEJOR PARECE LA REGRESIÓN O LA RED CON BPROP +EARLY */
