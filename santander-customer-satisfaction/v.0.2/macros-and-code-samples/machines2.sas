...
/* EN ESTE CASO TAMBIÉN FUNCIONA BIEN BPROP (!) MEJORANDO LA REGRESIÓN
(LEVMAR NO LA MEJORA)
...
/* se ve mejor que el modelo 5 (bprop+early) parece ir bien, si quitamos la red levmar del gráfico */
