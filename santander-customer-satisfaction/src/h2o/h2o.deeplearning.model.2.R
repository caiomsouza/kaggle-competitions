...
h2o.deeplearning.model2.pred = h2o.predict(object = h2o.deeplearning.model2, newdata = test.hex)
h2o.deeplearning.model2.pred
class(h2o.deeplearning.model2.pred)


# Transform H20Frame to DataFrame
h2o.deeplearning.model2.pred.df <-as.data.frame(h2o.predict(object = h2o.deeplearning.model2, newdata = test.hex))
h2o.deeplearning.model2.pred.df
class(h2o.deeplearning.model2.pred.df)
...
submission <- data.frame(ID=test.id, TARGET=h2o.deeplearning.model2.pred.df)
cat("saving the submission file\n")
write.csv(submission, "outputs/predictions/h2o.deeplearning.model2.pred.df.csv", row.names = F)
